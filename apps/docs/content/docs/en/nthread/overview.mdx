---
title: "Why NThread?"
description: "NThread temporarily redirects one existing OS thread in a target process instead of creating a remote thread. This avoids CreateRemoteThread; it..."
---
