...
description: "Making every Struct or CFunction choose local and remote APIs leaks transport details into higher layers. Accessors keep those details below a..."
---
