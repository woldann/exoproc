---
title: "NHook and MinHook"
description: "Exoproc provides two inline-hook models. The choice depends on the target prologue, detour requirement, and runtime behavior you can accept."
---
