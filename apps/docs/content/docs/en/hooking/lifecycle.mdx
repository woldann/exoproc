...
description: "create, enable, disable, and destroy are separate operations. NHook and MinHook share these names but do not share the same hit and cleanup behavior."
---
