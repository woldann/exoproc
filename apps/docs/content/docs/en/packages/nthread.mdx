---
title: "Using an NThread-backed accessor"
description: "Most users should not construct IndirectNThreadHostAccessor directly. createAccessor() builds and initializes the default chain. Its default..."
---
