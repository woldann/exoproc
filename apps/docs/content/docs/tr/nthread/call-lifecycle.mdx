...
Genel Win64 instruction simülasyonu NThread yaşam döngüsünden ayrılmıştır. Process açma, thread seçme, disassembly, register ve memory görünümünü denemek için [Win64 Debugger](/docs/playground/win64-debugger) sayfasını kullanın.
