---
title: "Neden NThread?"
description: "NThread, yeni bir uzak thread oluşturmak yerine hedef process'te zaten yaşayan **tek** bir OS thread'ini geçici olarak yönlendirir. Bu,..."
---
...
NThread görünmez veya risksiz değildir. Yeni thread oluşturmamak, mimari bir tercihtir; hedefin davranışını doğru seçme yükünü kullanıcıdan kaldırmaz. Devam etmeden önce [thread seçimi](/tr/docs/nthread/thread-selection), [çağrı yaşam döngüsü](/tr/docs/nthread/call-lifecycle) ve [hata sınırlarını](/tr/docs/nthread/failure-modes) okuyun.
