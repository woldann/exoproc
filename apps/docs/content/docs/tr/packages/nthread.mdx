---
title: "NThread tabanlı accessor kullanımı"
description: "Çoğu kullanıcı IndirectNThreadHostAccessor sınıfını doğrudan kurmaz. createAccessor() varsayılan accessor zincirini kurar, başlatır ve kullanıma..."
---
