---
title: "XFFI kullanım rehberi"
description: "bun-xffi, exoproc-utils dışındaki Exoproc paketlerinin tip, bellek ve çağrı temelidir. Adındaki **x**, cross-process çalışmayı; **ffi**, C ABI ile..."
---
