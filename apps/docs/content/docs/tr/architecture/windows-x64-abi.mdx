...
Çağrıyı önce argümansız veya basit tamsayı imzalı, yan etkisi düşük bir fonksiyonla doğrulamak en güvenli başlangıçtır. Çağrı akışının geri kalanı için [NThread yaşam döngüsüne](/docs/nthread/call-lifecycle) bakın.
