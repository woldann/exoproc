---
title: "Windows x64 ABI ve NThread"
description: "NThread, çağrının adresini bilmenin yanında Windows x64 çağrı sözleşmesine uygun bir register ve stack durumu kurmak zorundadır. Bu sayfa ABI'nin..."
---
...
Çağrıyı önce argümansız veya basit tamsayı imzalı, yan etkisi düşük bir fonksiyonla doğrulamak en güvenli başlangıçtır. Çağrı akışının geri kalanı için [NThread yaşam döngüsüne](/tr/docs/nthread/call-lifecycle) bakın.
