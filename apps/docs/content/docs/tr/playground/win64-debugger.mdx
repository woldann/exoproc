...
- **TARAYICI**: Cheat Engine mantığında bellek tarayıcı — bkz. [Bellek tarayıcı](/docs/playground/memory-scanner)
- **TERMINAL**: [xterm.js](https://xtermjs.org) ile render edilen gerçek bir simüle `cmd.exe` oturumu — debug edilen process'ten bağımsız, aynı makinede ayrı bir process olarak çalışır. Bkz. [debugger component API](/docs/playground/debugger-component#terminal-paneli).
