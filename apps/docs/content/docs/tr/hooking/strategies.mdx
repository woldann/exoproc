---
title: "NHook ve MinHook"
description: "Exoproc iki inline hook modeli sağlar. Seçim “hangisi daha iyi?” sorusu değil; hedef prologue'u, detour gereksinimi ve kabul edilen çalışma zamanı..."
---
...
Her iki hook için de [yaşam döngüsünü](/tr/docs/hooking/lifecycle) ve kontrollü hedef üzerindeki enable/disable testini temel alın.
